Shader "Hidden/FXAA"
{
    ...
    CGINCLUDE
        ...
        EdgeData DetermineEdge(LuminanceData l)
        {
            ...
            + abs(l.ne + l.se - 2 * l.e) + abs(l.nw + l.sw - 2 * l.w);
            float vertival = abs(l.e+ l.w - 2 * l.m) * 2
            + abs(l.ne + l.nw - 2 * l.n) + abs(l.se + l.sw - 2 * l.s);
            e.isHorizontal = horizontal >= vertival;
